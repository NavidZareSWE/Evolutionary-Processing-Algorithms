...
type VisualizationType = 'ga-sim' | 'selection' | 'crossover' | 'landscape' | 'schema';
  ...
  const visualizations: VisualizationInfo[] = [
    {
      id: 'ga-sim',
      title: 'GA Simulation',
      description: 'Watch a genetic algorithm evolve to solve the OneMax problem',
      icon: <Play size={20} />,
    ...
    <div className="visualizations-view">
      <div className="view-header">
        ...
        <p className="view-subtitle">
          Learn by experimenting with these interactive simulations of evolutionary computing concepts
        </p>
      </div>
