...
export default function GASimulation() {
  ...
  const tournamentSelect = useCallback(
  ...
  const crossover = useCallback(
    (parent1: Individual, parent2: Individual): [number[], number[]] => {
    ...
    <div className="visualization-container">
      <div className="viz-header">
        ...
        <p className="viz-description">
          Watch evolution in action! The GA tries to find a binary string of all
          1s. Each cell represents a gene (green=1, red=0). The fitness equals
          the count of 1s.
        </p>
      </div>
      ...
      <div className="viz-stats">
        ...
        <div className="stat-box">
          ...
          <span className="stat-value highlight">
            {bestIndividual?.fitness || 0} / {geneLength}
          </span>
        </div>
        <div className="stat-box">
        ...
        <div className="fitness-chart">
          ...
          <div className="chart-container">
            <svg viewBox="0 0 400 150" className="chart-svg">
              ...
              {/* Axis labels */}
              <text x="20" y="15" fill="var(--surface-300)" fontSize="10">
                100%
              </text>
              <text x="20" y="130" fill="var(--surface-300)" fontSize="10">
                0%
              </text>
              <text
                x="200"
            ...
            <div className="chart-legend">
              <span className="legend-item">
                <span className="legend-color best"></span> Best
              </span>
              <span className="legend-item">
                <span className="legend-color avg"></span> Average
              </span>
            </div>
          </div>
        </div>
      ...
      {bestIndividual?.fitness === geneLength && (
        <div className="success-message">
          🎉 Solution found in {generation} generations! The GA discovered the
          optimal string of all 1s.
        </div>
      )}
    </div>
  );
